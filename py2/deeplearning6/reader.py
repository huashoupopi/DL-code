...
from image_untis import image_augment
from insect_reader import get_insect_names, get_annotations
...
# 将list形式的测试batch数据 转化成多个array构成的tuple
...
if __name__ == "__main__":
    ...
    for batch_id, data in enumerate(train_loader()):
        img, gt_boxes, gt_labels, img_shape = data
        print(f"batch_id:{batch_id} img's shape:{img.shape} gt_box's shape；{gt_boxes.shape} gt_label's shape:{gt_labels.shape}")
